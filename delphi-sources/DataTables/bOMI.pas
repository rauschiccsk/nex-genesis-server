...
type
  ...
  private
    ...
    function  Readx_PAPrice:double;      procedure Writex_PAPrice (pValue:double);
    ...
    function  Readx_FIFOStr:Str224;      procedure Writex_FIFOStr (pValue:Str224);
  ...
  published
    ...
    property x_PAPrice:double read Readx_PAPrice write Writex_PAPrice;
    ...
    property x_FIFOStr:Str224 read Readx_FIFOStr write Writex_FIFOStr;
...
constructor TOmiBtr.Create;
begin
  oBtrTable := BtrInit ('OMI',gPath.StkPath,Self);
end;

constructor TOmiBtr.Create(pPath:ShortString);
begin
  oBtrTable := BtrInit ('OMI',pPath,Self);
end;

destructor TOmiBtr.Destroy;
begin
...
function TOmiBtr.ReadCount:integer;
begin
  Result := oBtrTable.RecordCount;
end;

function TOmiBtr.FieldExist (pFieldName:ShortString): boolean;
begin
  Result := oBtrTable.FindField(pFieldName)<>nil;
end;

function TOmiBtr.ReadStkNum:word;
begin
  Result := oBtrTable.FieldByName('StkNum').AsInteger;
end;

procedure TOmiBtr.WriteStkNum(pValue:word);
begin
  oBtrTable.FieldByName('StkNum').AsInteger := pValue;
end;

function TOmiBtr.ReadDocNum:Str12;
begin
  Result := oBtrTable.FieldByName('DocNum').AsString;
end;

procedure TOmiBtr.WriteDocNum(pValue:Str12);
begin
  oBtrTable.FieldByName('DocNum').AsString := pValue;
end;

function TOmiBtr.ReadItmNum:word;
begin
  Result := oBtrTable.FieldByName('ItmNum').AsInteger;
end;

procedure TOmiBtr.WriteItmNum(pValue:word);
begin
  oBtrTable.FieldByName('ItmNum').AsInteger := pValue;
end;

function TOmiBtr.ReadConStk:word;
begin
  Result := oBtrTable.FieldByName('ConStk').AsInteger;
end;

procedure TOmiBtr.WriteConStk(pValue:word);
begin
  oBtrTable.FieldByName('ConStk').AsInteger := pValue;
end;

function TOmiBtr.ReadMgCode:word;
begin
  Result := oBtrTable.FieldByName('MgCode').AsInteger;
end;

procedure TOmiBtr.WriteMgCode(pValue:word);
begin
  oBtrTable.FieldByName('MgCode').AsInteger := pValue;
end;

function TOmiBtr.ReadGsCode:longint;
begin
  Result := oBtrTable.FieldByName('GsCode').AsInteger;
end;

procedure TOmiBtr.WriteGsCode(pValue:longint);
begin
  oBtrTable.FieldByName('GsCode').AsInteger := pValue;
end;

function TOmiBtr.ReadGsName:Str30;
begin
  Result := oBtrTable.FieldByName('GsName').AsString;
end;

procedure TOmiBtr.WriteGsName(pValue:Str30);
begin
  oBtrTable.FieldByName('GsName').AsString := pValue;
end;

function TOmiBtr.Readx_GsName:Str30;
begin
  Result := oBtrTable.FieldByName('x_GsName').AsString;
end;

procedure TOmiBtr.Writex_GsName(pValue:Str30);
begin
  oBtrTable.FieldByName('x_GsName').AsString := pValue;
end;

function TOmiBtr.ReadBarCode:Str15;
begin
  Result := oBtrTable.FieldByName('BarCode').AsString;
end;

procedure TOmiBtr.WriteBarCode(pValue:Str15);
begin
  oBtrTable.FieldByName('BarCode').AsString := pValue;
end;

function TOmiBtr.ReadStkCode:Str15;
begin
  Result := oBtrTable.FieldByName('StkCode').AsString;
end;

procedure TOmiBtr.WriteStkCode(pValue:Str15);
begin
  oBtrTable.FieldByName('StkCode').AsString := pValue;
end;

function TOmiBtr.ReadMsName:Str10;
begin
  Result := oBtrTable.FieldByName('MsName').AsString;
end;

procedure TOmiBtr.WriteMsName(pValue:Str10);
begin
  oBtrTable.FieldByName('MsName').AsString := pValue;
end;

function TOmiBtr.Readx_BStQnt:double;
begin
  Result := oBtrTable.FieldByName('x_BStQnt').AsFloat;
end;

procedure TOmiBtr.Writex_BStQnt(pValue:double);
begin
  oBtrTable.FieldByName('x_BStQnt').AsFloat := pValue;
end;

function TOmiBtr.ReadGsQnt:double;
begin
  Result := oBtrTable.FieldByName('GsQnt').AsFloat;
end;

procedure TOmiBtr.WriteGsQnt(pValue:double);
begin
  oBtrTable.FieldByName('GsQnt').AsFloat := pValue;
end;

function TOmiBtr.ReadExpQnt:double;
begin
  Result := oBtrTable.FieldByName('ExpQnt').AsFloat;
end;

procedure TOmiBtr.WriteExpQnt(pValue:double);
begin
  oBtrTable.FieldByName('ExpQnt').AsFloat := pValue;
end;

function TOmiBtr.Readx_BStVal:double;
begin
  Result := oBtrTable.FieldByName('x_BStVal').AsFloat;
end;

procedure TOmiBtr.Writex_BStVal(pValue:double);
begin
  oBtrTable.FieldByName('x_BStVal').AsFloat := pValue;
end;

function TOmiBtr.Readx_AStVal:double;
begin
  Result := oBtrTable.FieldByName('x_AStVal').AsFloat;
end;

procedure TOmiBtr.Writex_AStVal(pValue:double);
begin
  oBtrTable.FieldByName('x_AStVal').AsFloat := pValue;
end;

function TOmiBtr.ReadVatPrc:double;
begin
  Result := oBtrTable.FieldByName('VatPrc').AsFloat;
end;

procedure TOmiBtr.WriteVatPrc(pValue:double);
begin
  oBtrTable.FieldByName('VatPrc').AsFloat := pValue;
end;

function TOmiBtr.ReadCPrice:double;
begin
  Result := oBtrTable.FieldByName('CPrice').AsFloat;
end;

procedure TOmiBtr.WriteCPrice(pValue:double);
begin
  oBtrTable.FieldByName('CPrice').AsFloat := pValue;
end;

function TOmiBtr.ReadEPrice:double;
begin
  Result := oBtrTable.FieldByName('EPrice').AsFloat;
end;

procedure TOmiBtr.WriteEPrice(pValue:double);
begin
  oBtrTable.FieldByName('EPrice').AsFloat := pValue;
end;

function TOmiBtr.ReadCValue:double;
begin
  Result := oBtrTable.FieldByName('CValue').AsFloat;
end;

procedure TOmiBtr.WriteCValue(pValue:double);
begin
  oBtrTable.FieldByName('CValue').AsFloat := pValue;
end;

function TOmiBtr.ReadEValue:double;
begin
  Result := oBtrTable.FieldByName('EValue').AsFloat;
end;

procedure TOmiBtr.WriteEValue(pValue:double);
begin
  oBtrTable.FieldByName('EValue').AsFloat := pValue;
end;

function TOmiBtr.Readx_PAPrice:double;
begin
  Result := oBtrTable.FieldByName('x_PAPrice').AsFloat;
end;

procedure TOmiBtr.Writex_PAPrice(pValue:double);
begin
  oBtrTable.FieldByName('x_PAPrice').AsFloat := pValue;
end;

function TOmiBtr.ReadBPrice:double;
begin
  Result := oBtrTable.FieldByName('BPrice').AsFloat;
end;

procedure TOmiBtr.WriteBPrice(pValue:double);
begin
  oBtrTable.FieldByName('BPrice').AsFloat := pValue;
end;

function TOmiBtr.ReadAValue:double;
begin
  Result := oBtrTable.FieldByName('AValue').AsFloat;
end;

procedure TOmiBtr.WriteAValue(pValue:double);
begin
  oBtrTable.FieldByName('AValue').AsFloat := pValue;
end;

function TOmiBtr.ReadBValue:double;
begin
  Result := oBtrTable.FieldByName('BValue').AsFloat;
end;

procedure TOmiBtr.WriteBValue(pValue:double);
begin
  oBtrTable.FieldByName('BValue').AsFloat := pValue;
end;

function TOmiBtr.ReadNotice:Str40;
begin
  Result := oBtrTable.FieldByName('Notice').AsString;
end;

procedure TOmiBtr.WriteNotice(pValue:Str40);
begin
  oBtrTable.FieldByName('Notice').AsString := pValue;
end;

function TOmiBtr.ReadDocDate:TDatetime;
begin
  Result := oBtrTable.FieldByName('DocDate').AsDateTime;
end;

procedure TOmiBtr.WriteDocDate(pValue:TDatetime);
begin
  oBtrTable.FieldByName('DocDate').AsDateTime := pValue;
end;

function TOmiBtr.ReadStkStat:Str1;
begin
  Result := oBtrTable.FieldByName('StkStat').AsString;
end;

procedure TOmiBtr.WriteStkStat(pValue:Str1);
begin
  oBtrTable.FieldByName('StkStat').AsString := pValue;
end;

function TOmiBtr.ReadCrtUser:Str8;
begin
  Result := oBtrTable.FieldByName('CrtUser').AsString;
end;

procedure TOmiBtr.WriteCrtUser(pValue:Str8);
begin
  oBtrTable.FieldByName('CrtUser').AsString := pValue;
end;

function TOmiBtr.ReadCrtDate:TDatetime;
begin
  Result := oBtrTable.FieldByName('CrtDate').AsDateTime;
end;

procedure TOmiBtr.WriteCrtDate(pValue:TDatetime);
begin
  oBtrTable.FieldByName('CrtDate').AsDateTime := pValue;
end;

function TOmiBtr.ReadCrtTime:TDatetime;
begin
  Result := oBtrTable.FieldByName('CrtTime').AsDateTime;
end;

procedure TOmiBtr.WriteCrtTime(pValue:TDatetime);
begin
  oBtrTable.FieldByName('CrtTime').AsDateTime := pValue;
end;

function TOmiBtr.ReadModUser:Str8;
begin
  Result := oBtrTable.FieldByName('ModUser').AsString;
end;

procedure TOmiBtr.WriteModUser(pValue:Str8);
begin
  oBtrTable.FieldByName('ModUser').AsString := pValue;
end;

function TOmiBtr.ReadModDate:TDatetime;
begin
  Result := oBtrTable.FieldByName('ModDate').AsDateTime;
end;

procedure TOmiBtr.WriteModDate(pValue:TDatetime);
begin
  oBtrTable.FieldByName('ModDate').AsDateTime := pValue;
end;

function TOmiBtr.ReadModTime:TDatetime;
begin
  Result := oBtrTable.FieldByName('ModTime').AsDateTime;
end;

procedure TOmiBtr.WriteModTime(pValue:TDatetime);
begin
  oBtrTable.FieldByName('ModTime').AsDateTime := pValue;
end;

function TOmiBtr.Readx_ImpName:Str8;
begin
  Result := oBtrTable.FieldByName('x_ImpName').AsString;
end;

procedure TOmiBtr.Writex_ImpName(pValue:Str8);
begin
  oBtrTable.FieldByName('x_ImpName').AsString := pValue;
end;

function TOmiBtr.Readx_ImpDate:TDatetime;
begin
  Result := oBtrTable.FieldByName('x_ImpDate').AsDateTime;
end;

procedure TOmiBtr.Writex_ImpDate(pValue:TDatetime);
begin
  oBtrTable.FieldByName('x_ImpDate').AsDateTime := pValue;
end;

function TOmiBtr.Readx_ImpTime:TDatetime;
begin
  Result := oBtrTable.FieldByName('x_ImpTime').AsDateTime;
end;

procedure TOmiBtr.Writex_ImpTime(pValue:TDatetime);
begin
  oBtrTable.FieldByName('x_ImpTime').AsDateTime := pValue;
end;

function TOmiBtr.ReadOcdItm:longint;
begin
  Result := oBtrTable.FieldByName('OcdItm').AsInteger;
end;

procedure TOmiBtr.WriteOcdItm(pValue:longint);
begin
  oBtrTable.FieldByName('OcdItm').AsInteger := pValue;
end;

function TOmiBtr.ReadOcdNum:Str12;
begin
  Result := oBtrTable.FieldByName('OcdNum').AsString;
end;

procedure TOmiBtr.WriteOcdNum(pValue:Str12);
begin
  oBtrTable.FieldByName('OcdNum').AsString := pValue;
end;

function TOmiBtr.ReadModNum:word;
begin
  Result := oBtrTable.FieldByName('ModNum').AsInteger;
end;

procedure TOmiBtr.WriteModNum(pValue:word);
begin
  oBtrTable.FieldByName('ModNum').AsInteger := pValue;
end;

function TOmiBtr.ReadSrcDoc:Str12;
begin
  Result := oBtrTable.FieldByName('SrcDoc').AsString;
end;

procedure TOmiBtr.WriteSrcDoc(pValue:Str12);
begin
  oBtrTable.FieldByName('SrcDoc').AsString := pValue;
end;

function TOmiBtr.ReadSrcItm:word;
begin
  Result := oBtrTable.FieldByName('SrcItm').AsInteger;
end;

procedure TOmiBtr.WriteSrcItm(pValue:word);
begin
  oBtrTable.FieldByName('SrcItm').AsInteger := pValue;
end;

function TOmiBtr.ReadPosCode:Str15;
begin
  Result := oBtrTable.FieldByName('PosCode').AsString;
end;

procedure TOmiBtr.WritePosCode(pValue:Str15);
begin
  oBtrTable.FieldByName('PosCode').AsString := pValue;
end;

function TOmiBtr.Readx_FIFOStr:Str224;
begin
  Result := oBtrTable.FieldByName('x_FIFOStr').AsString;
end;

procedure TOmiBtr.Writex_FIFOStr(pValue:Str224);
begin
  oBtrTable.FieldByName('x_FIFOStr').AsString := pValue;
end;

function TOmiBtr.Readx_Note1:Str60;
begin
  Result := oBtrTable.FieldByName('x_Note1').AsString;
end;

procedure TOmiBtr.Writex_Note1(pValue:Str60);
begin
  oBtrTable.FieldByName('x_Note1').AsString := pValue;
end;

function TOmiBtr.Readx_Note2:Str60;
begin
  Result := oBtrTable.FieldByName('x_Note2').AsString;
end;

procedure TOmiBtr.Writex_Note2(pValue:Str60);
begin
  oBtrTable.FieldByName('x_Note2').AsString := pValue;
end;

function TOmiBtr.Readx_Note3:Str60;
begin
  Result := oBtrTable.FieldByName('x_Note3').AsString;
end;

procedure TOmiBtr.Writex_Note3(pValue:Str60);
begin
  oBtrTable.FieldByName('x_Note3').AsString := pValue;
end;

function TOmiBtr.ReadRbaCode:Str30;
begin
  Result := oBtrTable.FieldByName('RbaCode').AsString;
end;

procedure TOmiBtr.WriteRbaCode(pValue:Str30);
begin
  oBtrTable.FieldByName('RbaCode').AsString := pValue;
end;

function TOmiBtr.ReadRbaDate:TDatetime;
begin
  Result := oBtrTable.FieldByName('RbaDate').AsDateTime;
end;

procedure TOmiBtr.WriteRbaDate(pValue:TDatetime);
begin
...
function TOmiBtr.Eof: boolean;
begin
  Result := oBtrTable.Eof;
end;

function TOmiBtr.IsFirstRec: boolean;
begin
  Result := oBtrTable.Bof;
end;

function TOmiBtr.IsLastRec: boolean;
begin
  Result := oBtrTable.Eof;
end;

function TOmiBtr.Active: boolean;
begin
  Result := oBtrTable.Active;
end;

function TOmiBtr.ActPos: longint;
begin
  Result := oBtrTable.ActPos;
end;

function TOmiBtr.GotoPos (pActPos:longint): boolean;
begin
  Result := oBtrTable.GotoPos(pActPos);
end;

function TOmiBtr.LocateStDoIt (pStkNum:word;pDocNum:Str12;pItmNum:word):boolean;
begin
  SetIndex (ixStDoIt);
  Result := oBtrTable.FindKey([pStkNum,pDocNum,pItmNum]);
end;

function TOmiBtr.LocateDoIt (pDocNum:Str12;pItmNum:word):boolean;
begin
  SetIndex (ixDoIt);
  Result := oBtrTable.FindKey([pDocNum,pItmNum]);
end;

function TOmiBtr.LocateItmNum (pItmNum:word):boolean;
begin
  SetIndex (ixItmNum);
  Result := oBtrTable.FindKey([pItmNum]);
end;

function TOmiBtr.LocateGsCode (pGsCode:longint):boolean;
begin
  SetIndex (ixGsCode);
  Result := oBtrTable.FindKey([pGsCode]);
end;

function TOmiBtr.LocateMgGs (pMgCode:word;pGsCode:longint):boolean;
begin
  SetIndex (ixMgGs);
  Result := oBtrTable.FindKey([pMgCode,pGsCode]);
end;

function TOmiBtr.LocateGsName (px_GsName:Str30):boolean;
begin
  SetIndex (ixGsName);
  Result := oBtrTable.FindKey([px_GsName]);
end;

function TOmiBtr.LocateCPrice (pCPrice:double):boolean;
begin
  SetIndex (ixCPrice);
  Result := oBtrTable.FindKey([pCPrice]);
end;

function TOmiBtr.LocateBarCode (pBarCode:Str15):boolean;
begin
  SetIndex (ixBarCode);
  Result := oBtrTable.FindKey([pBarCode]);
end;

function TOmiBtr.LocateStkCode (pStkCode:Str15):boolean;
begin
  SetIndex (ixStkCode);
  Result := oBtrTable.FindKey([pStkCode]);
end;

function TOmiBtr.LocateGsQnt (pGsQnt:double):boolean;
begin
  SetIndex (ixGsQnt);
  Result := oBtrTable.FindKey([pGsQnt]);
end;

function TOmiBtr.LocateStkStat (pStkStat:Str1):boolean;
begin
  SetIndex (ixStkStat);
  Result := oBtrTable.FindKey([pStkStat]);
end;

function TOmiBtr.LocateConStk (pConStk:word):boolean;
begin
  SetIndex (ixConStk);
  Result := oBtrTable.FindKey([pConStk]);
end;

function TOmiBtr.LocateDocNum (pDocNum:Str12):boolean;
begin
  SetIndex (ixDocNum);
  Result := oBtrTable.FindKey([pDocNum]);
end;

function TOmiBtr.LocatePosCode (pPosCode:Str15):boolean;
begin
  SetIndex (ixPosCode);
  Result := oBtrTable.FindKey([pPosCode]);
end;

function TOmiBtr.LocateRbaCode (pRbaCode:Str30):boolean;
begin
  SetIndex (ixRbaCode);
  Result := oBtrTable.FindKey([pRbaCode]);
end;

function TOmiBtr.NearestStDoIt (pStkNum:word;pDocNum:Str12;pItmNum:word):boolean;
begin
  SetIndex (ixStDoIt);
  Result := oBtrTable.FindNearest([pStkNum,pDocNum,pItmNum]);
end;

function TOmiBtr.NearestDoIt (pDocNum:Str12;pItmNum:word):boolean;
begin
  SetIndex (ixDoIt);
  Result := oBtrTable.FindNearest([pDocNum,pItmNum]);
end;

function TOmiBtr.NearestItmNum (pItmNum:word):boolean;
begin
  SetIndex (ixItmNum);
  Result := oBtrTable.FindNearest([pItmNum]);
end;

function TOmiBtr.NearestGsCode (pGsCode:longint):boolean;
begin
  SetIndex (ixGsCode);
  Result := oBtrTable.FindNearest([pGsCode]);
end;

function TOmiBtr.NearestMgGs (pMgCode:word;pGsCode:longint):boolean;
begin
  SetIndex (ixMgGs);
  Result := oBtrTable.FindNearest([pMgCode,pGsCode]);
end;

function TOmiBtr.NearestGsName (px_GsName:Str30):boolean;
begin
  SetIndex (ixGsName);
  Result := oBtrTable.FindNearest([px_GsName]);
end;

function TOmiBtr.NearestCPrice (pCPrice:double):boolean;
begin
  SetIndex (ixCPrice);
  Result := oBtrTable.FindNearest([pCPrice]);
end;

function TOmiBtr.NearestBarCode (pBarCode:Str15):boolean;
begin
  SetIndex (ixBarCode);
  Result := oBtrTable.FindNearest([pBarCode]);
end;

function TOmiBtr.NearestStkCode (pStkCode:Str15):boolean;
begin
  SetIndex (ixStkCode);
  Result := oBtrTable.FindNearest([pStkCode]);
end;

function TOmiBtr.NearestGsQnt (pGsQnt:double):boolean;
begin
  SetIndex (ixGsQnt);
  Result := oBtrTable.FindNearest([pGsQnt]);
end;

function TOmiBtr.NearestStkStat (pStkStat:Str1):boolean;
begin
  SetIndex (ixStkStat);
  Result := oBtrTable.FindNearest([pStkStat]);
end;

function TOmiBtr.NearestConStk (pConStk:word):boolean;
begin
  SetIndex (ixConStk);
  Result := oBtrTable.FindNearest([pConStk]);
end;

function TOmiBtr.NearestDocNum (pDocNum:Str12):boolean;
begin
  SetIndex (ixDocNum);
  Result := oBtrTable.FindNearest([pDocNum]);
end;

function TOmiBtr.NearestPosCode (pPosCode:Str15):boolean;
begin
  SetIndex (ixPosCode);
  Result := oBtrTable.FindNearest([pPosCode]);
end;

function TOmiBtr.NearestRbaCode (pRbaCode:Str30):boolean;
begin
  SetIndex (ixRbaCode);
  Result := oBtrTable.FindNearest([pRbaCode]);
end;

procedure TOmiBtr.SetIndex (pIndexName:ShortString);
begin
  If oBtrTable.IndexName<>pIndexName then oBtrTable.IndexName := pIndexName;
end;

procedure TOmiBtr.Open(pBookNum:Str5);
begin
  oBookNum := pBookNum;
  oBtrTable.Open(pBookNum);
end;

procedure TOmiBtr.Close;
begin
  If oBtrTable.Active then oBtrTable.Close;
end;

procedure TOmiBtr.Prior;
begin
  oBtrTable.Prior;
end;

procedure TOmiBtr.Next;
begin
  oBtrTable.Next;
end;

procedure TOmiBtr.First;
begin
  oBtrTable.First;
end;

procedure TOmiBtr.Last;
begin
  oBtrTable.Last;
end;

procedure TOmiBtr.Insert;
begin
  oBtrTable.Insert;
end;

procedure TOmiBtr.Edit;
begin
  oBtrTable.Edit;
end;

procedure TOmiBtr.Post;
begin
  oBtrTable.Post;
end;

procedure TOmiBtr.Delete;
begin
  oBtrTable.Delete;
end;

procedure TOmiBtr.SwapIndex;
begin
  oBtrTable.SwapIndex;
end;

procedure TOmiBtr.RestoreIndex;
begin
  oBtrTable.RestoreIndex;
end;

procedure TOmiBtr.SwapStatus;
begin
  oBtrTable.SwapStatus;
end;

procedure TOmiBtr.RestoreStatus;
begin
  oBtrTable.RestoreStatus;
end;

procedure TOmiBtr.EnableControls;
begin
  oBtrTable.EnableControls;
end;

procedure TOmiBtr.DisableControls;
begin
