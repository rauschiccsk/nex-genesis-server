...
constructor TPoiTmp.Create;
begin
  oTmpTable := TmpInit ('POI',Self);
end;

destructor TPoiTmp.Destroy;
begin
...
function TPoiTmp.ReadCount:integer;
begin
  Result := oTmpTable.RecordCount;
end;

function TPoiTmp.FieldExist (pFieldName:ShortString): boolean;
begin
  Result := oTmpTable.FindField(pFieldName)<>nil;
end;

function TPoiTmp.ReadDocNum:Str12;
begin
  Result := oTmpTable.FieldByName('DocNum').AsString;
end;

procedure TPoiTmp.WriteDocNum(pValue:Str12);
begin
  oTmpTable.FieldByName('DocNum').AsString := pValue;
end;

function TPoiTmp.ReadItmNum:word;
begin
  Result := oTmpTable.FieldByName('ItmNum').AsInteger;
end;

procedure TPoiTmp.WriteItmNum(pValue:word);
begin
  oTmpTable.FieldByName('ItmNum').AsInteger := pValue;
end;

function TPoiTmp.ReadMgCode:word;
begin
  Result := oTmpTable.FieldByName('MgCode').AsInteger;
end;

procedure TPoiTmp.WriteMgCode(pValue:word);
begin
  oTmpTable.FieldByName('MgCode').AsInteger := pValue;
end;

function TPoiTmp.ReadGsCode:longint;
begin
  Result := oTmpTable.FieldByName('GsCode').AsInteger;
end;

procedure TPoiTmp.WriteGsCode(pValue:longint);
begin
  oTmpTable.FieldByName('GsCode').AsInteger := pValue;
end;

function TPoiTmp.ReadGsName:Str30;
begin
  Result := oTmpTable.FieldByName('GsName').AsString;
end;

procedure TPoiTmp.WriteGsName(pValue:Str30);
begin
  oTmpTable.FieldByName('GsName').AsString := pValue;
end;

function TPoiTmp.ReadBarCode:Str15;
begin
  Result := oTmpTable.FieldByName('BarCode').AsString;
end;

procedure TPoiTmp.WriteBarCode(pValue:Str15);
begin
  oTmpTable.FieldByName('BarCode').AsString := pValue;
end;

function TPoiTmp.ReadStkCode:Str15;
begin
  Result := oTmpTable.FieldByName('StkCode').AsString;
end;

procedure TPoiTmp.WriteStkCode(pValue:Str15);
begin
  oTmpTable.FieldByName('StkCode').AsString := pValue;
end;

function TPoiTmp.ReadNotice:Str30;
begin
  Result := oTmpTable.FieldByName('Notice').AsString;
end;

procedure TPoiTmp.WriteNotice(pValue:Str30);
begin
  oTmpTable.FieldByName('Notice').AsString := pValue;
end;

function TPoiTmp.ReadWriNum:word;
begin
  Result := oTmpTable.FieldByName('WriNum').AsInteger;
end;

procedure TPoiTmp.WriteWriNum(pValue:word);
begin
  oTmpTable.FieldByName('WriNum').AsInteger := pValue;
end;

function TPoiTmp.ReadStkNum:word;
begin
  Result := oTmpTable.FieldByName('StkNum').AsInteger;
end;

procedure TPoiTmp.WriteStkNum(pValue:word);
begin
  oTmpTable.FieldByName('StkNum').AsInteger := pValue;
end;

function TPoiTmp.ReadVolume:double;
begin
  Result := oTmpTable.FieldByName('Volume').AsFloat;
end;

procedure TPoiTmp.WriteVolume(pValue:double);
begin
  oTmpTable.FieldByName('Volume').AsFloat := pValue;
end;

function TPoiTmp.ReadWeight:double;
begin
  Result := oTmpTable.FieldByName('Weight').AsFloat;
end;

procedure TPoiTmp.WriteWeight(pValue:double);
begin
  oTmpTable.FieldByName('Weight').AsFloat := pValue;
end;

function TPoiTmp.ReadPackGs:longint;
begin
  Result := oTmpTable.FieldByName('PackGs').AsInteger;
end;

procedure TPoiTmp.WritePackGs(pValue:longint);
begin
  oTmpTable.FieldByName('PackGs').AsInteger := pValue;
end;

function TPoiTmp.ReadGsType:Str1;
begin
  Result := oTmpTable.FieldByName('GsType').AsString;
end;

procedure TPoiTmp.WriteGsType(pValue:Str1);
begin
  oTmpTable.FieldByName('GsType').AsString := pValue;
end;

function TPoiTmp.ReadMsName:Str10;
begin
  Result := oTmpTable.FieldByName('MsName').AsString;
end;

procedure TPoiTmp.WriteMsName(pValue:Str10);
begin
  oTmpTable.FieldByName('MsName').AsString := pValue;
end;

function TPoiTmp.ReadGsQnt:double;
begin
  Result := oTmpTable.FieldByName('GsQnt').AsFloat;
end;

procedure TPoiTmp.WriteGsQnt(pValue:double);
begin
  oTmpTable.FieldByName('GsQnt').AsFloat := pValue;
end;

function TPoiTmp.ReadVatPrc:byte;
begin
  Result := oTmpTable.FieldByName('VatPrc').AsInteger;
end;

procedure TPoiTmp.WriteVatPrc(pValue:byte);
begin
  oTmpTable.FieldByName('VatPrc').AsInteger := pValue;
end;

function TPoiTmp.ReadDscPrc:double;
begin
  Result := oTmpTable.FieldByName('DscPrc').AsFloat;
end;

procedure TPoiTmp.WriteDscPrc(pValue:double);
begin
  oTmpTable.FieldByName('DscPrc').AsFloat := pValue;
end;

function TPoiTmp.ReadHPrice:double;
begin
  Result := oTmpTable.FieldByName('HPrice').AsFloat;
end;

procedure TPoiTmp.WriteHPrice(pValue:double);
begin
  oTmpTable.FieldByName('HPrice').AsFloat := pValue;
end;

function TPoiTmp.ReadBPrice:double;
begin
  Result := oTmpTable.FieldByName('BPrice').AsFloat;
end;

procedure TPoiTmp.WriteBPrice(pValue:double);
begin
  oTmpTable.FieldByName('BPrice').AsFloat := pValue;
end;

function TPoiTmp.ReadCValue:double;
begin
  Result := oTmpTable.FieldByName('CValue').AsFloat;
end;

procedure TPoiTmp.WriteCValue(pValue:double);
begin
  oTmpTable.FieldByName('CValue').AsFloat := pValue;
end;

function TPoiTmp.ReadDValue:double;
begin
  Result := oTmpTable.FieldByName('DValue').AsFloat;
end;

procedure TPoiTmp.WriteDValue(pValue:double);
begin
  oTmpTable.FieldByName('DValue').AsFloat := pValue;
end;

function TPoiTmp.ReadHValue:double;
begin
  Result := oTmpTable.FieldByName('HValue').AsFloat;
end;

procedure TPoiTmp.WriteHValue(pValue:double);
begin
  oTmpTable.FieldByName('HValue').AsFloat := pValue;
end;

function TPoiTmp.ReadAValue:double;
begin
  Result := oTmpTable.FieldByName('AValue').AsFloat;
end;

procedure TPoiTmp.WriteAValue(pValue:double);
begin
  oTmpTable.FieldByName('AValue').AsFloat := pValue;
end;

function TPoiTmp.ReadBValue:double;
begin
  Result := oTmpTable.FieldByName('BValue').AsFloat;
end;

procedure TPoiTmp.WriteBValue(pValue:double);
begin
  oTmpTable.FieldByName('BValue').AsFloat := pValue;
end;

function TPoiTmp.ReadDocDate:TDatetime;
begin
  Result := oTmpTable.FieldByName('DocDate').AsDateTime;
end;

procedure TPoiTmp.WriteDocDate(pValue:TDatetime);
begin
  oTmpTable.FieldByName('DocDate').AsDateTime := pValue;
end;

function TPoiTmp.ReadPaCode:longint;
begin
  Result := oTmpTable.FieldByName('PaCode').AsInteger;
end;

procedure TPoiTmp.WritePaCode(pValue:longint);
begin
  oTmpTable.FieldByName('PaCode').AsInteger := pValue;
end;

function TPoiTmp.ReadCasNum:byte;
begin
  Result := oTmpTable.FieldByName('CasNum').AsInteger;
end;

procedure TPoiTmp.WriteCasNum(pValue:byte);
begin
  oTmpTable.FieldByName('CasNum').AsInteger := pValue;
end;

function TPoiTmp.ReadCadNum:Str12;
begin
  Result := oTmpTable.FieldByName('CadNum').AsString;
end;

procedure TPoiTmp.WriteCadNum(pValue:Str12);
begin
  oTmpTable.FieldByName('CadNum').AsString := pValue;
end;

function TPoiTmp.ReadOcdNum:Str12;
begin
  Result := oTmpTable.FieldByName('OcdNum').AsString;
end;

procedure TPoiTmp.WriteOcdNum(pValue:Str12);
begin
  oTmpTable.FieldByName('OcdNum').AsString := pValue;
end;

function TPoiTmp.ReadOcdItm:word;
begin
  Result := oTmpTable.FieldByName('OcdItm').AsInteger;
end;

procedure TPoiTmp.WriteOcdItm(pValue:word);
begin
  oTmpTable.FieldByName('OcdItm').AsInteger := pValue;
end;

function TPoiTmp.ReadTcdNum:Str12;
begin
  Result := oTmpTable.FieldByName('TcdNum').AsString;
end;

procedure TPoiTmp.WriteTcdNum(pValue:Str12);
begin
  oTmpTable.FieldByName('TcdNum').AsString := pValue;
end;

function TPoiTmp.ReadTcdItm:word;
begin
  Result := oTmpTable.FieldByName('TcdItm').AsInteger;
end;

procedure TPoiTmp.WriteTcdItm(pValue:word);
begin
  oTmpTable.FieldByName('TcdItm').AsInteger := pValue;
end;

function TPoiTmp.ReadIcdNum:Str12;
begin
  Result := oTmpTable.FieldByName('IcdNum').AsString;
end;

procedure TPoiTmp.WriteIcdNum(pValue:Str12);
begin
  oTmpTable.FieldByName('IcdNum').AsString := pValue;
end;

function TPoiTmp.ReadIcdItm:word;
begin
  Result := oTmpTable.FieldByName('IcdItm').AsInteger;
end;

procedure TPoiTmp.WriteIcdItm(pValue:word);
begin
  oTmpTable.FieldByName('IcdItm').AsInteger := pValue;
end;

function TPoiTmp.ReadPrcDst:Str1;
begin
  Result := oTmpTable.FieldByName('PrcDst').AsString;
end;

procedure TPoiTmp.WritePrcDst(pValue:Str1);
begin
  oTmpTable.FieldByName('PrcDst').AsString := pValue;
end;

function TPoiTmp.ReadEpdUsrc:Str10;
begin
  Result := oTmpTable.FieldByName('EpdUsrc').AsString;
end;

procedure TPoiTmp.WriteEpdUsrc(pValue:Str10);
begin
  oTmpTable.FieldByName('EpdUsrc').AsString := pValue;
end;

function TPoiTmp.ReadEpaUsrc:Str10;
begin
  Result := oTmpTable.FieldByName('EpaUsrc').AsString;
end;

procedure TPoiTmp.WriteEpaUsrc(pValue:Str10);
begin
  oTmpTable.FieldByName('EpaUsrc').AsString := pValue;
end;

function TPoiTmp.ReadEptUsrc:Str10;
begin
  Result := oTmpTable.FieldByName('EptUsrc').AsString;
end;

procedure TPoiTmp.WriteEptUsrc(pValue:Str10);
begin
  oTmpTable.FieldByName('EptUsrc').AsString := pValue;
end;

function TPoiTmp.ReadEpsUsrc:Str10;
begin
  Result := oTmpTable.FieldByName('EpsUsrc').AsString;
end;

procedure TPoiTmp.WriteEpsUsrc(pValue:Str10);
begin
  oTmpTable.FieldByName('EpsUsrc').AsString := pValue;
end;

function TPoiTmp.ReadCrtUser:Str8;
begin
  Result := oTmpTable.FieldByName('CrtUser').AsString;
end;

procedure TPoiTmp.WriteCrtUser(pValue:Str8);
begin
  oTmpTable.FieldByName('CrtUser').AsString := pValue;
end;

function TPoiTmp.ReadCrtDate:TDatetime;
begin
  Result := oTmpTable.FieldByName('CrtDate').AsDateTime;
end;

procedure TPoiTmp.WriteCrtDate(pValue:TDatetime);
begin
  oTmpTable.FieldByName('CrtDate').AsDateTime := pValue;
end;

function TPoiTmp.ReadCrtTime:TDatetime;
begin
  Result := oTmpTable.FieldByName('CrtTime').AsDateTime;
end;

procedure TPoiTmp.WriteCrtTime(pValue:TDatetime);
begin
  oTmpTable.FieldByName('CrtTime').AsDateTime := pValue;
end;

function TPoiTmp.ReadModNum:word;
begin
  Result := oTmpTable.FieldByName('ModNum').AsInteger;
end;

procedure TPoiTmp.WriteModNum(pValue:word);
begin
  oTmpTable.FieldByName('ModNum').AsInteger := pValue;
end;

function TPoiTmp.ReadModUser:Str8;
begin
  Result := oTmpTable.FieldByName('ModUser').AsString;
end;

procedure TPoiTmp.WriteModUser(pValue:Str8);
begin
  oTmpTable.FieldByName('ModUser').AsString := pValue;
end;

function TPoiTmp.ReadModDate:TDatetime;
begin
  Result := oTmpTable.FieldByName('ModDate').AsDateTime;
end;

procedure TPoiTmp.WriteModDate(pValue:TDatetime);
begin
  oTmpTable.FieldByName('ModDate').AsDateTime := pValue;
end;

function TPoiTmp.ReadModTime:TDatetime;
begin
  Result := oTmpTable.FieldByName('ModTime').AsDateTime;
end;

procedure TPoiTmp.WriteModTime(pValue:TDatetime);
begin
  oTmpTable.FieldByName('ModTime').AsDateTime := pValue;
end;

function TPoiTmp.ReadOutQnt:double;
begin
  Result := oTmpTable.FieldByName('OutQnt').AsFloat;
end;

procedure TPoiTmp.WriteOutQnt(pValue:double);
begin
  oTmpTable.FieldByName('OutQnt').AsFloat := pValue;
end;

function TPoiTmp.ReadDlvQnt:double;
begin
  Result := oTmpTable.FieldByName('DlvQnt').AsFloat;
end;

procedure TPoiTmp.WriteDlvQnt(pValue:double);
begin
  oTmpTable.FieldByName('DlvQnt').AsFloat := pValue;
end;

function TPoiTmp.ReadOrdQnt:double;
begin
  Result := oTmpTable.FieldByName('OrdQnt').AsFloat;
end;

procedure TPoiTmp.WriteOrdQnt(pValue:double);
begin
  oTmpTable.FieldByName('OrdQnt').AsFloat := pValue;
end;

function TPoiTmp.ReadActPos:longint;
begin
  Result := oTmpTable.FieldByName('ActPos').AsInteger;
end;

procedure TPoiTmp.WriteActPos(pValue:longint);
begin
...
function TPoiTmp.Eof: boolean;
begin
  Result := oTmpTable.Eof;
end;

function TPoiTmp.Active: boolean;
begin
  Result := oTmpTable.Active;
end;

function TPoiTmp.LocateDoIt (pDocNum:Str12;pItmNum:word):boolean;
begin
  SetIndex (ixDoIt);
  Result := oTmpTable.FindKey([pDocNum,pItmNum]);
end;

function TPoiTmp.LocateDocNum (pDocNum:Str12):boolean;
begin
  SetIndex (ixDocNum);
  Result := oTmpTable.FindKey([pDocNum]);
end;

function TPoiTmp.LocateItmNum (pItmNum:word):boolean;
begin
  SetIndex (ixItmNum);
  Result := oTmpTable.FindKey([pItmNum]);
end;

function TPoiTmp.LocateGsCode (pGsCode:longint):boolean;
begin
  SetIndex (ixGsCode);
  Result := oTmpTable.FindKey([pGsCode]);
end;

function TPoiTmp.LocateBarCode (pBarCode:Str15):boolean;
begin
  SetIndex (ixBarCode);
  Result := oTmpTable.FindKey([pBarCode]);
end;

function TPoiTmp.LocateDocDate (pDocDate:TDatetime):boolean;
begin
  SetIndex (ixDocDate);
  Result := oTmpTable.FindKey([pDocDate]);
end;

function TPoiTmp.LocateTnTi (pTcdNum:Str12;pTcdItm:word):boolean;
begin
  SetIndex (ixTnTi);
  Result := oTmpTable.FindKey([pTcdNum,pTcdItm]);
end;

function TPoiTmp.LocateInIi (pIcdNum:Str12;pIcdItm:word):boolean;
begin
  SetIndex (ixInIi);
  Result := oTmpTable.FindKey([pIcdNum,pIcdItm]);
end;

function TPoiTmp.LocateEpdUsrc (pEpdUsrc:Str10):boolean;
begin
  SetIndex (ixEpdUsrc);
  Result := oTmpTable.FindKey([pEpdUsrc]);
end;

function TPoiTmp.LocateEpaUsrc (pEpaUsrc:Str10):boolean;
begin
  SetIndex (ixEpaUsrc);
  Result := oTmpTable.FindKey([pEpaUsrc]);
end;

function TPoiTmp.LocateEptUsrc (pEptUsrc:Str10):boolean;
begin
  SetIndex (ixEptUsrc);
  Result := oTmpTable.FindKey([pEptUsrc]);
end;

function TPoiTmp.LocateEpsUsrc (pEpsUsrc:Str10):boolean;
begin
  SetIndex (ixEpsUsrc);
  Result := oTmpTable.FindKey([pEpsUsrc]);
end;

function TPoiTmp.LocateDnGc (pDocNum:Str12;pGsCode:longint):boolean;
begin
  SetIndex (ixDnGc);
  Result := oTmpTable.FindKey([pDocNum,pGsCode]);
end;

procedure TPoiTmp.SetIndex (pIndexName:ShortString);
begin
  If oTmpTable.IndexName<>pIndexName then oTmpTable.IndexName := pIndexName;
end;

procedure TPoiTmp.Open;
begin
  oTmpTable.Open;
end;

procedure TPoiTmp.Close;
begin
  If oTmpTable.Active then oTmpTable.Close;
end;

procedure TPoiTmp.Prior;
begin
  oTmpTable.Prior;
end;

procedure TPoiTmp.Next;
begin
  oTmpTable.Next;
end;

procedure TPoiTmp.First;
begin
  oTmpTable.First;
end;

procedure TPoiTmp.Last;
begin
  oTmpTable.Last;
end;

procedure TPoiTmp.Insert;
begin
  oTmpTable.Insert;
end;

procedure TPoiTmp.Edit;
begin
  oTmpTable.Edit;
end;

procedure TPoiTmp.Post;
var mEdit:boolean;
begin
  oTmpTable.Post;
end;

procedure TPoiTmp.Delete;
begin
  oTmpTable.Delete;
end;

procedure TPoiTmp.SwapIndex;
begin
  oTmpTable.SwapIndex;
end;

procedure TPoiTmp.RestoreIndex;
begin
  oTmpTable.RestoreIndex;
end;

procedure TPoiTmp.SwapStatus;
begin
  oTmpTable.SwapStatus;
end;

procedure TPoiTmp.RestoreStatus;
begin
  oTmpTable.RestoreStatus;
end;

procedure TPoiTmp.EnableControls;
begin
  oTmpTable.EnableControls;
end;

procedure TPoiTmp.DisableControls;
begin
