...
uses
  IcTypes, NexPath, NexGlob, bPKI,
  Forms, Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Dialogs;

type
  TPkiHnd = class (TPkiBtr)
  private
  public
...
function TPkiHnd.FreeItmNum(pDocNum:Str12):word;
...
function TPkiHnd.NextItmNum(pDocNum:Str12):word;
begin
...
procedure TPkiHnd.Del(pDocNum:Str12);
begin
