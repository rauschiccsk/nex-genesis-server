...
function  TF_QRNewS.Execute:boolean;
begin
  oCreate := FALSE;
//  CB_DataSet.Clear;
  CB_DataSet.Text := '';
...
procedure TF_QRNewS.ClearFldData;
var I:longint;
begin
...
procedure TF_QRNewS.ClearDefData;
var I:longint;
begin
  For I:=0 to 200 do begin
    oDefData[I].Fld        := '';
...
procedure TF_QRNewS.DeleteFldData (pFld:string);
var
  I:longint;
  mFind:boolean;
begin
...
procedure TF_QRNewS.AddFldData (pFld:string);
var
  I,J:longint;
  mT:TIniFile;
  mS:string;
...
procedure TF_QRNewS.SaveFldData (pNum:longint);
var
  mT:TIniFile;
  mS:string;
  mSum:string;
...
function  TF_QRNewS.FindFldData (pFld:string):longint;
var
  I:longint;
  mFind:boolean;
begin
...
procedure TF_QRNewS.CB_PrintActPgNumClick(Sender: TObject);
begin
  If CB_PrintActPgNum.Focused then CB_PrintActPgQnt.Checked := FALSE;
end;

procedure TF_QRNewS.CB_PrintActPgQntClick(Sender: TObject);
begin
  If CB_PrintActPgQnt.Focused then CB_PrintActPgNum.Checked := FALSE;
end;

procedure TF_QRNewS.BB_CreateClick(Sender: TObject);
begin
  oCreate := TRUE;
  Close;
end;

procedure TF_QRNewS.BB_CancelClick(Sender: TObject);
begin
  Close;
end;

procedure TF_QRNewS.CB_DataSetChange(Sender: TObject);
var
  I:longint;
  mT:TIniFile;
  mS:string;
...
begin
  ...
  LB_AllFields.Items.Clear;
  try
    LB_AllFields.Items.AddStrings ((Owner as TF_QRMainH).FillFieldNames (CB_DataSet.Text));
  except end;
  mComp := (Owner as TF_QRMainH).GetTableObj (CB_DataSet.Text);
  mT := TIniFile.Create (cRepPath+'RepFld.Ini');
...
procedure TF_QRNewS.SB_RemoveSelItmClick(Sender: TObject);
var
  I,J:integer;
  mAdd:boolean;
begin
...
procedure TF_QRNewS.SB_CopyAllItmClick(Sender: TObject);
var
  I,J:integer;
  mAdd:boolean;
begin
...
procedure TF_QRNewS.SB_RemoveAllItmClick(Sender: TObject);
begin
  LB_PrintFields.Items.Clear;
  ClearFldData;
  P_Data.Enabled := FALSE;
...
procedure TF_QRNewS.LB_AllFieldsDragDrop(Sender, Source: TObject; X,
  Y: Integer);
begin
  SB_RemoveSelItmClick (Sender);
end;

procedure TF_QRNewS.LB_PrintFieldsDragDrop(Sender, Source: TObject; X,
  Y: Integer);
var
  mRect:TRect;
  mNewPos:TPoint;
...
procedure TF_QRNewS.SB_UpClick(Sender: TObject);
var mIt:integer;
begin
...
procedure TF_QRNewS.SB_DownClick(Sender: TObject);
var mIt:integer;
begin
...
procedure TF_QRNewS.LB_AllFieldsDblClick(Sender: TObject);
begin
  SB_CopySelItmClick (Sender);
end;

procedure TF_QRNewS.LB_PrintFieldsDblClick(Sender: TObject);
begin
  SB_RemoveSelItmClick (Sender);
end;

procedure TF_QRNewS.LB_PrintFieldsClick(Sender: TObject);
var
  I:longint;
  mFind:boolean;
  mFld:string;
...
procedure TF_QRNewS.KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
...
procedure TF_QRNewS.CB_SummaryKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  If Key=VK_RETURN then LB_PrintFields.SetFocus;
end;

procedure TF_QRNewS.LB_PrintFieldsKeyDown(Sender: TObject;
...
procedure TF_QRNewS.E_DisplayNameExit(Sender: TObject);
var I,J:longint;
begin
...
procedure TF_QRNewS.E_DisplayWidthExit(Sender: TObject);
var I:longint;
begin
  I := FindFldData (L_Fld.Caption);
  If I>-1 then begin
...
procedure TF_QRNewS.CB_NameAlignExit(Sender: TObject);
var I:longint;
begin
  I := FindFldData (L_Fld.Caption);
  If I>-1 then begin
...
procedure TF_QRNewS.CB_FldAlignExit(Sender: TObject);
var I:longint;
begin
  I := FindFldData (L_Fld.Caption);
  If I>-1 then begin
...
procedure TF_QRNewS.CB_FormatExit(Sender: TObject);
var I:longint;
begin
  I := FindFldData (L_Fld.Caption);
  If I>-1 then begin
...
procedure TF_QRNewS.CB_SummaryExit(Sender: TObject);
var I:longint;
begin
  I := FindFldData (L_Fld.Caption);
  If I>-1 then begin
...
procedure TF_QRNewS.E_DisplayWidthCharExit(Sender: TObject);
var I:longint;
begin
...
procedure TF_QRNewS.LB_AllFieldsKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  If Key=VK_RETURN then SB_CopySelItmClick(Sender);
end;

procedure TF_QRNewS.LB_PrintFieldsExit(Sender: TObject);
begin
