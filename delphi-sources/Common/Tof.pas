...
type
  TTof=class
    ...
    public
      procedure NewDoc(pTrmNum,pPaCode:longint;pPaName:Str30;pPlsNum:word;pCusCrd:Str20);  // VytvorÈ nov˝ doklad
...
// ********************************** PUBLIC ***********************************
procedure TTof.NewDoc(pTrmNum,pPaCode:longint;pPaName:Str30;pPlsNum:word;pCusCrd:Str20);
