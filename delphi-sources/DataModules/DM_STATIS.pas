...
uses 
  ...
  Db, DBTables, PxTable, DbfTable, BtrTable, NexBtrTable;

type
  TdmSTATIS = class(TDataModule)
    dtGSCAT: TDbfTable;
    dtMGCAT: TDbfTable;
    dtGSD: TDbfTable;
    dtSADC: TDbfTable;
...
procedure TdmSTATIS.OpenGSD (pDate:TDateTime);
...
procedure TdmSTATIS.OpenGSM (pYear:Str4);
begin
  oActYear := pYear;
...
procedure TdmSTATIS.OpenSADC (pYear:Str4);
begin
  oActYear := pYear;
...
procedure TdmSTATIS.OpenSAWC (pYear:Str4);
begin
  oActYear := pYear;
...
procedure TdmSTATIS.OpenSAMC (pYear:Str4);
begin
  oActYear := pYear;
...
procedure TdmSTATIS.OpenSAYC (pYear:Str4);
begin
  oActYear := pYear;
...
procedure TdmSTATIS.OpenSADP (pYear:Str4);
begin
  oActYear := pYear;
...
procedure TdmSTATIS.OpenSAWP (pYear:Str4);
begin
  oActYear := pYear;
...
procedure TdmSTATIS.OpenSAMP (pYear:Str4);
begin
  oActYear := pYear;
...
procedure TdmSTATIS.OpenSAYP (pYear:Str4);
begin
  oActYear := pYear;
...
procedure TdmSTATIS.OpenMSA (pSerNum:integer);  // Model maloochodn0ho predaja
begin
...
function TdmSTATIS.GetActYear:Str4; // Aktualny rok na ktory su otvorene databaze
begin
  Result := oActYear;
end;

function TdmSTATIS.GetActMsaNum:integer; // Aktualny model predaja
begin
  Result := oActMsaNum;
end;

procedure TdmSTATIS.dtGSCATBeforeOpen(DataSet: TDataSet);
begin
...
procedure TdmSTATIS.dtMGCATBeforeOpen(DataSet: TDataSet);
begin
...
procedure TdmSTATIS.dtGSDBeforeOpen(DataSet: TDataSet);
var I:byte;
begin
  dtGSD.DatabaseName := gIni.GetStaPath;
...
procedure TdmSTATIS.dtGSMBeforeOpen(DataSet: TDataSet);
var I:word;
begin
  dtGSM.DatabaseName := gIni.GetStaPath;
...
procedure TdmSTATIS.dtSADCBeforeOpen(DataSet: TDataSet);
var I: byte;
begin
...
procedure TdmSTATIS.dtSAWCBeforeOpen(DataSet: TDataSet);
var I: byte;
begin
...
procedure TdmSTATIS.dtSAMCBeforeOpen(DataSet: TDataSet);
var I: byte;
begin
...
procedure TdmSTATIS.dtSAYCBeforeOpen(DataSet: TDataSet);
var I: byte;
begin
...
procedure TdmSTATIS.dtSADPBeforeOpen(DataSet: TDataSet);
var I: byte;
begin
...
procedure TdmSTATIS.dtSAWPBeforeOpen(DataSet: TDataSet);
var I: byte;
begin
...
procedure TdmSTATIS.dtSAMPBeforeOpen(DataSet: TDataSet);
var I: byte;
begin
...
procedure TdmSTATIS.dtSAYPBeforeOpen(DataSet: TDataSet);
var I: byte;
begin
...
procedure TdmSTATIS.ptSAMGSUMBeforeOpen(DataSet: TDataSet);
begin
...
procedure TdmSTATIS.dtSAMGBeforeOpen(DataSet: TDataSet);
begin
...
procedure TdmSTATIS.ptSACASSUMBeforeOpen(DataSet: TDataSet);
begin
...
procedure TdmSTATIS.dtSADCBeforePost(DataSet: TDataSet);
...
begin
  ...
  For I:=1 to 15 do begin
    ...
    dtSADC.FieldByName ('CValue00').AsInteger := dtSADC.FieldByName ('CValue00').AsInteger+dmSTATIS.dtSADC.FieldByName ('CValue'+mCasNum).AsInteger;
    dtSADC.FieldByName ('ProfVal00').AsInteger := dtSADC.FieldByName ('ProfVal00').AsInteger+dmSTATIS.dtSADC.FieldByName ('ProfVal'+mCasNum).AsInteger;
    dtSADC.FieldByName ('AValue00').AsInteger := dtSADC.FieldByName ('AValue00').AsInteger+dmSTATIS.dtSADC.FieldByName ('AValue'+mCasNum).AsInteger;
    dtSADC.FieldByName ('BValue00').AsInteger := dtSADC.FieldByName ('BValue00').AsInteger+dmSTATIS.dtSADC.FieldByName ('BValue'+mCasNum).AsInteger;
    dtSADC.FieldByName ('DocCnt00').AsInteger := dtSADC.FieldByName ('DocCnt00').AsInteger+dmSTATIS.dtSADC.FieldByName ('DocCnt'+mCasNum).AsInteger;
  end;
...
procedure TdmSTATIS.dtSAWCBeforePost(DataSet: TDataSet);
var mCasNum:Str2; I:byte;
begin
  ...
  For I:=1 to 15 do begin
    ...
    dtSAWC.FieldByName ('CValue00').AsInteger := dtSAWC.FieldByName ('CValue00').AsInteger+dmSTATIS.dtSAWC.FieldByName ('CValue'+mCasNum).AsInteger;
    dtSAWC.FieldByName ('ProfVal00').AsInteger := dtSAWC.FieldByName ('ProfVal00').AsInteger+dmSTATIS.dtSAWC.FieldByName ('ProfVal'+mCasNum).AsInteger;
    dtSAWC.FieldByName ('AValue00').AsInteger := dtSAWC.FieldByName ('AValue00').AsInteger+dmSTATIS.dtSAWC.FieldByName ('AValue'+mCasNum).AsInteger;
    dtSAWC.FieldByName ('BValue00').AsInteger := dtSAWC.FieldByName ('BValue00').AsInteger+dmSTATIS.dtSAWC.FieldByName ('BValue'+mCasNum).AsInteger;
    dtSAWC.FieldByName ('DocCnt00').AsInteger := dtSAWC.FieldByName ('DocCnt00').AsInteger+dmSTATIS.dtSAWC.FieldByName ('DocCnt'+mCasNum).AsInteger;
  end;
...
procedure TdmSTATIS.dtSAMCBeforePost(DataSet: TDataSet);
var mCasNum:Str2; I:byte;
begin
  ...
  For I:=1 to 15 do begin
    mCasNum := StrIntZero (I,2);
    If dmSTATIS.dtSAMC.FieldByName('CValue'+mCasNum).AsInteger>0
      then dtSAMC.FieldByName ('ProfPrc'+mCasNum).AsFloat := Rd2(((dtSAMC.FieldByName ('AValue'+mCasNum).AsInteger/dmSTATIS.dtSAMC.FieldByName('CValue'+mCasNum).AsInteger)-1)*100);
...
procedure TdmSTATIS.dtSAYCBeforePost(DataSet: TDataSet);
var mCasNum:Str2; I:byte;
begin
  ...
  For I:=1 to 15 do begin
    ...
    If dtSAYC.FieldByName('CValue'+mCasNum).AsInteger>0
      then dtSAYC.FieldByName ('ProfPrc'+mCasNum).AsFloat := Rd2(((dtSAYC.FieldByName ('AValue'+mCasNum).AsInteger/dmSTATIS.dtSAYC.FieldByName('CValue'+mCasNum).AsInteger)-1)*100);
...
procedure TdmSTATIS.dtSADPBeforePost(DataSet: TDataSet);
...
procedure TdmSTATIS.dtSAWPBeforePost(DataSet: TDataSet);
...
procedure TdmSTATIS.dtSAMPBeforePost(DataSet: TDataSet);
...
procedure TdmSTATIS.dtSAYPBeforePost(DataSet: TDataSet);
...
procedure TdmSTATIS.ptSAGSSUMBeforeOpen(DataSet: TDataSet);
begin
...
procedure TdmSTATIS.dtMSALSTBeforeOpen(DataSet: TDataSet);
begin
...
procedure TdmSTATIS.dtMSABeforeOpen(DataSet: TDataSet);
begin
