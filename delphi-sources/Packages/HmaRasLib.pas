...
function RasDialDlg(
    lpszPhonebook, lpszEntry, lpszPhoneNumber: PAnsiChar;
    lpInfo: LPRasDialDlgA
   ): BOOL; stdcall;
 {$ELSE}
...
function RasDialDlg;                 external 'rasdlg.dll'   name 'RasDialDlgA';
{$ENDIF}
{*
